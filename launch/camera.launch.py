...
def launch_setup(context, *args, **kwargs):
    ...
    return [
        ...
        # Convert pointcloud into metric units
        ...
        #                     remappings=[('image_raw', '/oak/stereo/image_raw'),
...
def generate_launch_description():
    ...
    detection_pkg_prefix = get_package_share_directory("detection_pkg")

    declared_arguments = [
        DeclareLaunchArgument("name", default_value="oak"),
        DeclareLaunchArgument("parent_frame", default_value="oak-d-base-frame"),
        # DeclareLaunchArgument("parent_frame", default_value="map"),
        # DeclareLaunchArgument("parent_frame", default_value="tripod"),
        DeclareLaunchArgument("camera_model", default_value="OAK-D"),
        # DeclareLaunchArgument("cam_pos_x", default_value="0.05"),
        # DeclareLaunchArgument("cam_pos_y", default_value="0.01"),
        # DeclareLaunchArgument("cam_pos_z", default_value="1.0"),
        # DeclareLaunchArgument("cam_roll", default_value="0.0"),
        # DeclareLaunchArgument("cam_pitch", default_value="0.3490659"),
        ...
        DeclareLaunchArgument("cam_yaw", default_value="0.0"),
        DeclareLaunchArgument("params_file", default_value=os.path.join(detection_pkg_prefix, 'config', 'camera.yaml')),
        ...
        DeclareLaunchArgument("imu_from_descr", default_value='true', description='Enables IMU publishing from URDF.'),
