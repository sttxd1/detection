...
# Launches camera in stereo mode and uses depth-image-proc to turn the stereo image into a pointcloud
# also attached a static boardcaster node and the bottom which connects the oak-d-base-frame to the map frame
...
def generate_launch_description():
    ...
    static_tf_oakd_map = launch_ros.actions.Node(package = "tf2_ros", 
    ...
    ld.add_action(static_tf_oakd_map)
